...
def run_mvp(n: int, T: int, seed: int):
    ...
    # pin every legacy-frozen parameter explicitly: the MVP's own defaults
    # are allowed to move (they have: x_0=100, etc.) but the lineage proof
    # runs in the legacy gauge, always
