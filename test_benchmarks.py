...
CASES = {
    ...
    "home_default_n150":      dict(tp=0.01, sl=0.01, n=150, T=4000, seed=42, c=0.004, close_mode="home",
                                   sl_mode="market", entry_mode="ioc", hold_fires_close=False),
    "quantity_treatment":     dict(tp=0.01, sl=0.01, n=150, T=4000, seed=42, c=0.004, close_mode="quantity",
                                   sl_mode="market", entry_mode="ioc", hold_fires_close=False),
    "sl_limit_arm":           dict(tp=0.01, sl=0.01, n=150, T=2000, seed=7, c=0.004, close_mode="quantity",
                                   sl_mode="limit", entry_mode="ioc", hold_fires_close=False),
    "sl_wait_arm":            dict(tp=0.01, sl=0.01, n=150, T=2000, seed=7, c=0.004, close_mode="quantity",
                                   sl_mode="wait", entry_mode="ioc", hold_fires_close=False),
    "conv_mixed_evolve":      dict(tp=0.01, sl=0.01, n=60, T=1500, seed=3, c=0.02, close_mode="home",
                                   sl_mode="market", entry_mode="ioc", hold_fires_close=False,
                                   conv_mode="mixed", evolve=True, evolve_every=400),
    "tp_hierarchy":           dict(n=150, T=2000, seed=1, c=0.004, close_mode="home",
                                   sl_mode="market", entry_mode="ioc", hold_fires_close=False,
                                   tp_sig_hier=True, tp=0.01, sl=0.01),
    "entry_rest_v5":          dict(tp=0.01, sl=0.01, n=150, T=2000, seed=1, c=0.004, close_mode="home",
                                   sl_mode="market", entry_mode="rest", hold_fires_close=False),
    "rest_impatience":        dict(tp=0.01, sl=0.01, n=150, T=2000, seed=1, c=0.004, close_mode="home",
                                   sl_mode="market", entry_mode="rest", hold_fires_close=True),
    "coin_book":              dict(n=150, T=2000, seed=1, c=0.004, tp=0.01, sl=0.01,
                                   close_mode="home", sl_mode="market", entry_mode="rest",
                                   hold_fires_close=True, book_mode="coin"),
    "coin_book_mirror":       dict(n=150, T=2000, seed=1, c=0.004, tp=0.01, sl=0.01,
                                   close_mode="home", sl_mode="market", entry_mode="rest",
                                   hold_fires_close=True, book_mode="coin", mirror=True),
    "reference_row_f05_s1":   dict(tp=0.01, sl=0.01, f=0.5, c=0.004, T=6000, seed=1, close_mode="home",
                                   sl_mode="market", entry_mode="ioc", hold_fires_close=False,
