...
CASES = {
    ...
    "home_default_n150":      dict(n=150, T=4000, seed=42, c=0.004, close_mode="home",
    ...
    "quantity_treatment":     dict(n=150, T=4000, seed=42, c=0.004, close_mode="quantity",
                                   sl_mode="market", entry_mode="ioc", hold_fires_close=False),
    "sl_limit_arm":           dict(n=150, T=2000, seed=7, c=0.004, close_mode="quantity",
                                   sl_mode="limit", entry_mode="ioc", hold_fires_close=False),
    "sl_wait_arm":            dict(n=150, T=2000, seed=7, c=0.004, close_mode="quantity",
                                   sl_mode="wait", entry_mode="ioc", hold_fires_close=False),
    "conv_mixed_evolve":      dict(n=60, T=1500, seed=3, c=0.02, close_mode="home",
                                   sl_mode="market", entry_mode="ioc", hold_fires_close=False,
    ...
    "entry_rest_v5":          dict(n=150, T=2000, seed=1, c=0.004, close_mode="home",
                                   sl_mode="market", entry_mode="rest", hold_fires_close=False),
    "rest_impatience":        dict(n=150, T=2000, seed=1, c=0.004, close_mode="home",
                                   sl_mode="market", entry_mode="rest", hold_fires_close=True),
    "reference_row_f05_s1":   dict(f=0.5, c=0.004, T=6000, seed=1, close_mode="home",
                                   sl_mode="market", entry_mode="ioc", hold_fires_close=False,
